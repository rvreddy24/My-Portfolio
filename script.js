...
const projects = [
    {
        title: "WalletWatch",
        description: "A modern web application for personal finance management with real-time tracking and visualization. Features include real-time dashboard, transaction tracking, smart analytics, monthly trend tracking, responsive design, data persistence, and export functionality.",
        technologies: ["HTML5", "CSS3", "JavaScript", "Chart.js", "Local Storage API"],
        icon: "fas fa-wallet",
        color: "#2ecc71",
        link: "https://rvreddy24.github.io/Wallet_Watch/"
    },
    {
        title: "CSV Analyzer",
